...
func (p *ToutiaoPlatform) Name() string {
	return "toutiao"
}

func (p *ToutiaoPlatform) Version() string {
	return "1.0.0"
}

func (p *ToutiaoPlatform) NewLogin(page *rod.Page) platform.LoginAction {
	return &ToutiaoLoginAction{page: page}
}

func (p *ToutiaoPlatform) NewPublishAction(page *rod.Page) (platform.PublishAction, error) {
	return &ToutiaoPublishAction{page: page}
}

type ToutiaoLoginAction struct {
	page *rod.Page
}

func (a *ToutiaoLoginAction) CheckLoginStatus(ctx context.Context) (bool, error) {
	return common.CheckLoginWithRetry(ctx, a.checkLoginStatus, 3)
}

func (a *ToutiaoLoginAction) FetchQrcodeImage(ctx context.Context) (string, bool, error) {
...
func (a *ToutiaoLoginAction) WaitForLogin(ctx context.Context) bool {
	return common.CheckLoginWithRetry(ctx, a.waitForLogin, 120)
}

func (a *ToutiaoLoginAction) ExtractCookies(ctx context.Context) (map[string]string, error) {
...
func (a *ToutiaoLoginAction) checkLoginStatus(ctx context.Context) (bool, error) {
	...
	if err := pp.Navigate(toutiaoLoginURL); err != nil {
...
func (a *ToutiaoLoginAction) fetchQrcode(ctx context.Context) (string, error) {
	pp := a.page.Context(ctx)
...
type ToutiaoPublishAction struct {
	page *rod.Page
}

func (p *ToutiaoPublishAction) PublishImages(ctx context.Context, content platform.PublishImageContent) error {
	...
	if err := common.SafeNavigate(pp, toutiaoPublishURL, 60*time.Second); err != nil {
		return err
	}
...
func (p *ToutiaoPublishAction) PublishVideo(ctx context.Context, content platform.PublishVideoContent) error {
...
func (p *ToutiaoPublishAction) uploadImages(page *rod.Page, imagePaths []string) error {
...
func (p *ToutiaoPublishAction) uploadVideo(page *rod.Page, videoPath string) error {
...
func (p *ToutiaoPublishAction) fillContent(page *rod.Page, title, content string, tags []string) error {
...
func (p *ToutiaoPublishAction) inputTags(page *rod.Page, tags []string) error {
...
func (p *ToutiaoPublishAction) submitPublish(page *rod.Page) error {
